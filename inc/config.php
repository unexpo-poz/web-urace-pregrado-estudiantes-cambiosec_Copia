...
$raizDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace/pregrado/estudiantes/cambiosec_Copia/';
$urlDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace';

$lapsoProceso		= '2015-2';
$tLapso				= ' Lapso '.$lapsoProceso;

$laBitacora	 = $_SERVER[DOCUMENT_ROOT].'/log/pregrado/estudiantes/cambio/cambiosec-Copia'.$lapsoProceso.'.log';
